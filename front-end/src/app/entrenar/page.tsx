  ...
  return (
    <main className="min-h-screen p-6 text-white">
      ...
      <div className="flex items-center justify-between mb-8">
        <Link
          href="/"
          className="px-4 py-2 rounded-xl bg-red-600 hover:bg-red-500 transition flex items-center gap-2 shadow-lg"
        >
          <LogOut size={18} />
          Salir
        </Link>
      ...
      <div className="w-full text-center mb-8">
        ...
        <p className="text-lg opacity-80 mb-4">{motivationalText}</p>
      ...
      {selectedMuscle && (
        <div className="max-w-xl mx-auto mb-6">
          <label className="text-xl font-semibold">Ejercicio</label>
          <select
        ...
        {showSummary && (
          ...
          >
            ...
            >
              ...
              <Link
                href="/"
                className="mt-4 inline-block px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 transition"
              >
                Volver al inicio
              </Link>
            </motion.div>
